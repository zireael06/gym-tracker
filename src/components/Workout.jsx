...
function Workout ({ name, routineExercises, completedWorkouts, onFinish, startTime }) {
    ...
    function addExercise() {
        ...
        setExercises([
            ...exercises,
            {id: crypto.randomUUID(), name: newExerciseName.trim(), sets: []}
            ]);
    ...
    return (
        <div className="workout">
            ...
            <p>Workout: {formattedMinutes}:{formattedSeconds}</p>
